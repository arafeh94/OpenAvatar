...
from core.plugins.lip_sync.wave2lip.dataset import Dataset
...
parser.add_argument("--data_root", help="Root folder of the preprocessed LRS2 dataset", required=False, type=str,
                    default="/home/arafeh/files/")

parser.add_argument('--checkpoint_dir', help='Save checkpoints to this directory', required=False, type=str,
                    default='/home/arafeh/files/')
parser.add_argument('--syncnet_checkpoint_path', help='Load the pre-trained Expert discriminator', required=False,
...
if __name__ == "__main__":
    ...
    train_dataset = Dataset.default_list()
    test_dataset = Dataset.default_list()
